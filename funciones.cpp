...
void producto_mas_vendido(int &cont1, int &cont2, int &cont3, int &cont4, int &cont5)
{
	...
	if(cont3>=cont1 and cont3>=cont2 and cont3>=cont4 and cont3>=cont5)
	{
		cout<<"--------------------------------------------------------------------------------"<<endl;
	...
	if(cont4>=cont1 and cont4>=cont2 and cont4>=cont3 and cont4>=cont5)
	{
		cout<<"--------------------------------------------------------------------------------"<<endl;
		cout<<"PRODUCTO MAS VENDIDO: MEDIAS "<<endl;
		cout<<"N. de clientes: "<<cont4<<endl;
	}
	if(cont5>=cont1 and cont5>=cont2 and cont5>=cont3 and cont5>=cont4)
	{
		cout<<"--------------------------------------------------------------------------------"<<endl;
